    ...
    $("#buscar_produtos").autocomplete({
        ...
        select: function (event, ui) {
            ...
            if (ui.item.value === 'Produto não encontrado') {
                ...
                var produto_quantidade_estoque = ui.item.produto_quantidade_estoque;
                ...
                $("input.qty").keyup(function () {
                    ...
                    if (parseInt($(this).val()) > parseInt(produto_quantidade_estoque)) {

                        Swal.fire({
                            icon: 'warning',
                            width: 300,
                            title: 'Desculpe!',
                            html: 'Só temos <strong><u>' + produto_quantidade_estoque + '</u></strong> unidades em estoque',
                        })
