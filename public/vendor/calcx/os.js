...
if ($counter > 0) {
    ...
    $('#table_servicos tr').each(function () {
        ...
        var servico = $(this).find("input.servico_nome").val();
    ...
    $("#buscar_servicos").autocomplete({
        ...
        select: function (event, ui) {
            ...
            if (ui.item.value === 'Serviço não encontrado') {
                ...
                var servico_nome = ui.item.value;
                ...
                var markup = '<tr>\
                    ...
                    <td><input title="Nome do servico" type="text" name="servico_nome[]" value="' + servico_nome + '" class="servico_nome form-control form-control-user input-sm" data-cell="B' + i + '" readonly></td>\
                    ...
                    <td class="text-center"><input type="hidden" name="valor_desconto_servico[]" data-cell="H' + i + '"  data-format="R$ 0,0.00" data-formula="((C' + i + '*D' + i + ')-F' + i + ')"><button title="Remover o serviço" class="btn-remove btn btn-sm btn-danger"><i class="fas fa-trash-alt"></i></button></td>\
                </tr>';

                /*Início bloco que verifica se o serviço já foi adicionado à ordem*/
                result_add = servicos_adicionados.includes(servico_nome);
                ...
                if (result_add == true) {
                    ...
                    servicos_adicionados.push(servico_nome);
                }
...
$('#lista_servicos').on('click', '.btn-remove', function () {
    ...
    var servico_to_remove = $(this).closest('tr').find("input.servico_nome").val();
