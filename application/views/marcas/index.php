                                    ...
                                    <tbody>
                                        <?php foreach($marcas as $marca): ?>
                                            <tr>
                                                ...
                                                <td><?php echo mb_strimwidth($marca->marca_nome, 0, 30, '...'); ?></td>
                                                <td><?php echo formata_data_banco_sem_hora($marca->marca_data_alteracao); ?></td>
                                                <td class="text-center">
                                                    <?php if($marca->marca_ativo == 1) {
                                                ...
                                                <td class="text-center">
                                                    <a title="Editar"
                                                        href="<?php echo base_url($this->router->fetch_class().'/edit/'.$marca->marca_id); ?>"
                                                    ...
                                                    <a title="Excluir"
                                                        ...
                                                        data-toggle="modal"
                                                        data-target="#marca-<?php echo $marca->marca_id; ?>">
                                            ...
                                            <!-- Delete Modal-->
                                            <div class="modal fade" id="marca-<?php echo $marca->marca_id; ?>" tabindex="-1" role="dialog" 
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            href="<?php echo base_url($this->router->fetch_class().'/del/'.$marca->marca_id); ?>">Sim</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
