                ...
                <div class="container-fluid">
                    ...
                    <nav aria-label="breadcrumb">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a title="Marcas" href="<?php echo base_url($this->router->fetch_class()); ?>">Marcas</a></li>
                        ...
                        <div class="card-header py-3">
                            <div class="float-left">
                                ...
                                <p class="float-left">
                                    ...
                                    <?php echo formata_data_banco_com_hora($marca->marca_data_cadastro); ?>
                                </p>
                            </div>
                            <a title="Voltar" 
                                ...
                                <fieldset class="mb-4 p-2 border">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            placeholder="Informe o nome" value="<?php echo $marca->marca_nome; ?>" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            <select class="form-control custom-select" id="marca_ativo" name="marca_ativo">
                                                <option value="0" <?php echo ($marca->marca_ativo == 0 ? 'selected' : ''); ?>>Não</option>
                                                <option value="1" <?php echo ($marca->marca_ativo == 0 ? '' : 'selected'); ?>>Sim</option>
                                            </select>
                                        </div>
