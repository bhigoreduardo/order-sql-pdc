                        ...
                        <div class="card-header py-3">
                            <div class="float-left">
                                ...
                                <p class="float-left">
                                    ...
                                    <?php echo formata_data_banco_com_hora($produto->produto_data_cadastro); ?>
                                </p>
                            </div>
                            <a title="Voltar" 
                            ...
                            <form method="POST" name="form_edit">
                                <fieldset class="mb-4 p-2 border">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            placeholder="Informe o código" value="<?php echo $produto->produto_codigo; ?>" />
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            placeholder="Informe o código de barras" value="<?php echo $produto->produto_codigo_barras; ?>" />
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            placeholder="Informe o NCM" value="<?php echo $produto->produto_ncm; ?>" />
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            placeholder="Informe a descrição" value="<?php echo $produto->produto_descricao; ?>" />
                                ...
                                <fieldset class="mb-4 p-2 border">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            placeholder="Informe o preço de custo" value="<?php echo $produto->produto_preco_custo; ?>" />
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            placeholder="Informe o preço de venda" value="<?php echo $produto->produto_preco_venda; ?>" />
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            placeholder="Informe o preço de venda" value="<?php echo $produto->produto_estoque_minimo; ?>" />
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            placeholder="Informe o preço de venda" value="<?php echo $produto->produto_quantidade_estoque; ?>" />
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            placeholder="Informe o preço de venda" value="<?php echo $produto->produto_unidade; ?>" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            <select class="form-control custom-select" id="produto_ativo" name="produto_ativo">
                                                ...
                                                <option value="1" <?php echo ($produto->produto_ativo == 0 ? '' : 'selected'); ?>>Sim</option>
                                            </select>
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 mb-2">
                                        ...
                                        placeholder="Informe a abservação"><?php echo $produto->produto_obs; ?></textarea>
