                                    ...
                                    <tbody>
                                        <?php foreach($vendas as $venda): ?>
                                            <tr>
                                                ...
                                                <td><?php echo mb_strimwidth($venda->cliente, 0, 30, '...'); ?></td>
                                                <td><?php echo mb_strimwidth($venda->vendedor, 0, 30, '...'); ?></td>
                                                <td class="text-center"><?php echo formata_data_banco_sem_hora($venda->venda_data_cadastro); ?></td>
                                                <td class="text-center"><?php echo mb_strimwidth($venda->forma_pagamento, 0, 30, '...'); ?></td>
                                                <td class="text-center">
                                                    <?php echo 'R$&nbsp<span class="money">' . $venda->venda_valor_total . '</span>'; ?>
                                                </td>
                                                <td class="text-center">
                                                    <?php if($venda->venda_status == 1) {
                                                ...
                                                <td class="text-center">
                                                    <a title="Editar"
                                                        href="<?php echo base_url('vendas/edit/'.$venda->venda_id); ?>"
                                                    ...
                                                    <a title="Excluir"
                                                        ...
                                                        data-toggle="modal"
                                                        data-target="#venda-<?php echo $venda->venda_id; ?>">
                                            ...
                                            <!-- Delete Modal-->
                                            <div class="modal fade" id="venda-<?php echo $venda->venda_id; ?>" tabindex="-1" role="dialog" 
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            href="<?php echo base_url('vendas/del/'.$venda->venda_id); ?>">Sim</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
