            ...
            <!-- <footer class=""> -->
            <footer
                class="<?php echo ($this->router->fetch_class() == 'login' ? 'position-fixed fixed-bottom text-white footer mb-4' : 'sticky-footer bg-white footer'); ?>">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>
                            Copyright &copy; <?php echo Date('Y'); ?> Feito com 
                            ...
                            por <a href="" id="copy" class="<?php echo ($this->router->fetch_class() == 'login' ? 'text-white' : '')?>">
                                Higor E. Batista
                                </a>
                            </g-emoji>
                        </span>
    ...
    <script src="<?php echo base_url('public/js/demo/util.js'); ?>"></script>
