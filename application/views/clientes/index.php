                                    ...
                                    <tbody>
                                        <?php foreach($clientes as $cliente): ?>
                                            <tr>
                                                ...
                                                <td><?php echo mb_strimwidth($cliente->cliente_nome_razao, 0, 30, '...'); ?></td>
                                                <td class="<?php echo ($cliente->cliente_tipo == 1 ? 'cpf' : 'cnpj' ); ?>">
                                                    <?php echo $cliente->cliente_cpf_cnpj; ?>
                                                </td>
                                                <td>
                                                    <?php echo ($cliente->cliente_tipo == 1 ? 'Pessoa Física' : 'Pessoa Jurídica'); ?>
                                                </td>
                                                <td class="sp_celphones">
                                                    <?php echo $cliente->cliente_celular; ?>
                                                </td>
                                                <td><?php echo mb_strimwidth($cliente->cliente_endereco, 0, 20, '...'); ?></td>
                                                ...
                                                <td class="text-center">
                                                    <a title="Editar"
                                                        href="<?php echo base_url($this->router->fetch_class().'/edit/'.$cliente->cliente_id); ?>"
                                                    ...
                                                    <a title="Excluir"
                                                        ...
                                                        data-toggle="modal"
                                                        data-target="#cliente-<?php echo $cliente->cliente_id; ?>">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            href="<?php echo base_url($this->router->fetch_class().'/del/'.$cliente->cliente_id); ?>">Sim</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
