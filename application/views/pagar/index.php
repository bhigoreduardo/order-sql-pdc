                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a title="Cadastrar conta à pagar" 
                                    ...
                                    <tbody>
                                        <?php foreach($contas_pagar as $conta): ?>
                                            <tr>
                                                ...
                                                <td><?php echo mb_strimwidth($conta->fornecedor, 0, 30, '...'); ?></td>
                                                ...
                                                <td>
                                                    <?php
                                                        if($conta->conta_pagar_status == 1) {
                                                            echo formata_data_banco_sem_hora($conta->conta_pagar_data_pagamento);
                                                        } else {
                                                ...
                                                <td class="text-center">
                                                    <?php
                                                        if ($conta->conta_pagar_status == 1) {
                                                        ...
                                                        } else if ((strtotime(date('Y-m-d H:i:s')) + strtotime($conta->conta_pagar_data_vencimento) - strtotime('+2days')) == strtotime(date('Y-m-d'))) {
                                                            ...
                                                            echo '<span class="badge badge-secondary btn-sm">À pagar</span>';
                                                        } else if (strtotime($conta->conta_pagar_data_vencimento) == strtotime(date('Y-m-d'))) {
                                                ...
                                                <td class="text-center">
                                                    <a title="Editar"
                                                        href="<?php echo base_url($this->router->fetch_class().'/edit/'.$conta->conta_pagar_id); ?>"
                                            ...
                                            <!-- Delete Modal-->
                                            <div class="modal fade" id="conta-<?php echo $conta->conta_pagar_id; ?>" tabindex="-1" role="dialog" 
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            href="<?php echo base_url($this->router->fetch_class().'/del/'.$conta->conta_pagar_id); ?>">Sim</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
