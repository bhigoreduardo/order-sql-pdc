                                    ...
                                    <tbody>
                                        <?php foreach($contas_receber as $conta): ?>
                                            <tr>
                                                ...
                                                <td><?php echo mb_strimwidth($conta->cliente, 0, 30, '...'); ?></td>
                                                ...
                                                <td>
                                                    <?php
                                                        if($conta->conta_receber_status == 1) {
                                                            echo formata_data_banco_sem_hora($conta->conta_receber_data_pagamento);
                                                        } else {
                                                ...
                                                <td class="text-center">
                                                    <?php
                                                        if ($conta->conta_receber_status == 1) {
                                                        ...
                                                        } else if ((strtotime(date('Y-m-d H:i:s')) + strtotime($conta->conta_receber_data_vencimento) - strtotime('+2days')) == strtotime(date('Y-m-d'))) {
                                                            echo '<sapan class="badge badge-warning btn-sm">Vence 2 dias</span>';
                                                            ...
                                                            echo '<span class="badge badge-danger btn-sm">Vence hoje</span>';
                                                        } else {
                                                            echo '<span class="badge badge-danger btn-sm">Venceu</span>';
                                                        }
                                                    ?>
                                                </td>
                                                <td class="text-center">
                                                    <a title="Editar"
                                                        href="<?php echo base_url($this->router->fetch_class().'/edit/'.$conta->conta_receber_id); ?>"
                                                    ...
                                                    <a title="Excluir"
                                                        ...
                                                        data-toggle="modal"
                                                        data-target="#conta-<?php echo $conta->conta_receber_id; ?>">
                                            ...
                                            <!-- Delete Modal-->
                                            <div class="modal fade" id="conta-<?php echo $conta->conta_receber_id; ?>" tabindex="-1" role="dialog" 
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            href="<?php echo base_url($this->router->fetch_class().'/del/'.$conta->conta_receber_id); ?>">Sim</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
