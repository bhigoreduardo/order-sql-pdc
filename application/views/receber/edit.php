                        ...
                        <div class="card-header py-3">
                            <div class="float-left">
                                ...
                                <p class="float-left">
                                    ...
                                    <?php echo formata_data_banco_com_hora($conta_receber->conta_receber_data_cadastro); ?>
                                </p>
                            </div>
                            <a title="Voltar" 
                            ...
                            <form method="POST" name="form_edit">
                                <fieldset class="mb-4 p-2 border">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            placeholder="Informe o valor" value="<?php echo $conta_receber->conta_receber_valor; ?>" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            <select class="form-control custom-select" id="conta_receber_status" name="conta_receber_status">
                                                ...
                                                <option value="1" <?php echo ($conta_receber->conta_receber_status == 0 ? '' : 'selected'); ?>>Pago</option>
                                            </select>
                                        </div>
                                    </div>
                                </fieldset>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 mb-2">
                                        ...
                                        placeholder="Informe a abservação"><?php echo $conta_receber->conta_receber_obs; ?></textarea>
