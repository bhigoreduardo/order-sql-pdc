                            ...
                            <form method="POST" name="form_edit">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4 mb-2">
                                        ...
                                        placeholder="Informe o nome" value="<?php echo $usuario->first_name; ?>" />
                                    ...
                                    <div class="col-md-4 mb-2">
                                        ...
                                        placeholder="Informe o sobrenome" value="<?php echo $usuario->last_name; ?>"  />
                                    ...
                                    <div class="col-md-4 mb-2">
                                        ...
                                        placeholder="Informe o e-mail (login)" value="<?php echo $usuario->email; ?>" />
                                    ...
                                    <div class="col-md-4 mb-2">
                                        ...
                                        placeholder="Informe o nome de usuário" value="<?php echo $usuario->username; ?>" />
                                    ...
                                    <div class="col-md-4 mb-2">
                                        ...
                                        <select class="form-control custom-select" id="group" name="group">
                                            ...
                                            <option value="1" <?php echo ($perfil->id == 2) ? '' : 'selected'; ?>>Administrador</option>
                                        </select>
                                    </div>
                                    <!-- FIXME: password -->
