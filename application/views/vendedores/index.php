                                    ...
                                    <tbody>
                                        <?php foreach($vendedores as $vendedor): ?>
                                            <tr>
                                                ...
                                                <td><?php echo mb_strimwidth($vendedor->vendedor_nome_completo, 0, 30, '...'); ?></td>
                                                <td><?php echo $vendedor->vendedor_codigo; ?></td>
                                                <td class="sp_celphones"><?php echo $vendedor->vendedor_celular; ?></td>
                                                <td><?php echo mb_strimwidth($vendedor->vendedor_email, 0, 20, '...'); ?></td>
                                                <td><?php echo mb_strimwidth($vendedor->vendedor_endereco, 0, 20, '...'); ?></td>
                                                <td class="text-center">
                                                    <?php if($vendedor->vendedor_ativo == 1) {
                                                ...
                                                <td class="text-center">
                                                    <a title="Editar"
                                                        href="<?php echo base_url($this->router->fetch_class().'/edit/'.$vendedor->vendedor_id); ?>"
                                                    ...
                                                    <a title="Excluir"
                                                        ...
                                                        data-toggle="modal"
                                                        data-target="#vendedor-<?php echo $vendedor->vendedor_id; ?>">
                                            ...
                                            <!-- Delete Modal-->
                                            <div class="modal fade" id="vendedor-<?php echo $vendedor->vendedor_id; ?>" tabindex="-1" role="dialog" 
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            href="<?php echo base_url($this->router->fetch_class().'/del/'.$vendedor->vendedor_id); ?>">Sim</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
