                                    ...
                                    <tbody>
                                        <?php foreach($categorias as $categoria): ?>
                                            <tr>
                                                ...
                                                <td><?php echo mb_strimwidth($categoria->categoria_nome, 0, 30, '...'); ?></td>
                                                <td><?php echo formata_data_banco_sem_hora($categoria->categoria_data_alteracao); ?></td>
                                                ...
                                                <td class="text-center">
                                                    <a title="Editar"
                                                        href="<?php echo base_url($this->router->fetch_class().'/edit/'.$categoria->categoria_id); ?>"
                                                    ...
                                                    <a title="Excluir"
                                                        ...
                                                        data-toggle="modal"
                                                        data-target="#categoria-<?php echo $categoria->categoria_id; ?>">
                                            ...
                                            <!-- Delete Modal-->
                                            <div class="modal fade" id="categoria-<?php echo $categoria->categoria_id; ?>" tabindex="-1" role="dialog" 
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            href="<?php echo base_url($this->router->fetch_class().'/del/'.$categoria->categoria_id); ?>">Sim</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
