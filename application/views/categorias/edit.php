                ...
                <div class="container-fluid">
                    ...
                    <nav aria-label="breadcrumb">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a title="Categorias" href="<?php echo base_url($this->router->fetch_class()); ?>">Categorias</a></li>
                        ...
                        <div class="card-header py-3">
                            <div class="float-left">
                                ...
                                <p class="float-left">
                                    ...
                                    <?php echo formata_data_banco_com_hora($categoria->categoria_data_cadastro); ?>
                                </p>
                            </div>
                            <a title="Voltar" 
                            ...
                            <form method="POST" name="form_edit">
                                <fieldset class="mb-4 p-2 border">
                                    ...
                                    <div class="form-group row">
                                        <!-- FIXME: categoria_nome -->
                                        <div class="col-md-4 mb-2">
                                            <label for="categoria_nome">Nome</label>
                                            <input type="text" class="form-control form-control-user" id="categoria_nome" name="categoria_nome"
                                            placeholder="Informe o nome" value="<?php echo $categoria->categoria_nome; ?>" />
                                ...
                                <fieldset class="mb-4 p-2 border">
                                    ...
                                    <div class="form-group row">
                                        <!-- FIXME: categoria_ativo -->
                                        <div class="col-md-4 mb-2">
                                            <label for="categoria_ativo">Ativo</label>
                                            <select class="form-control custom-select" id="categoria_ativo" name="categoria_ativo">
                                                <option value="0" <?php echo ($categoria->categoria_ativo == 0 ? 'selected' : ''); ?>>Não</option>
                                                <option value="1" <?php echo ($categoria->categoria_ativo == 0 ? '' : 'selected'); ?>>Sim</option>
                                            </select>
                                        </div>
