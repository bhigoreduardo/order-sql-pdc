...
/* Ordens se serviços */
$route['ordens'] = 'Ordens_servicos/index';
$route['ordens/add'] = 'Ordens_servicos/add';
$route['ordens/edit/(:num)'] = 'Ordens_servicos/edit/$1';
$route['ordens/del/(:num)'] = 'Ordens_servicos/del/$1';